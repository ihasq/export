...
const _stub = getStub();
export const hello_sayHello = createSharedProxy(_stub, ["hello", "sayHello"]);
export const hello_MODULE_NAME = createSharedProxy(_stub, ["hello", "MODULE_NAME"]);
...
export const utils_math_multiply = createSharedProxy(_stub, ["utils/math", "multiply"]);
export const utils_math_divide = createSharedProxy(_stub, ["utils/math", "divide"]);
export const utils_math_PI = createSharedProxy(_stub, ["utils/math", "PI"]);
export { getStub };
